{{-- Estado del curso --}}
<div class="mt-8">
    <div class="container grid grid-cols-2 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2">
            ...
            <div class="flex justify-between mt-4">
                ...
                <div class="flex items-center cursor-pointer" wire:click="completed">
                    ...
                    @if ($current->completed)
                        <i class="fas fa-toggle-on text-2-xl text-blue-600"></i>
                    @else
                        <i class="fas fa-toggle-off text-2-xl text-gray-600"></i>
                    @endif

                    <p class="text-sm ml-2">Marcar como terminado</p>
                </div>
                @if ($current->resource)
            ...
            <div class="card mt-2">
                <div class="card-body flex text-gray-500 font-bols">
