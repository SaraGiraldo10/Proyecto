    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            <figure>
                ...
                @else
                    <img class="h-60 w-full object-cover" src="https://images.pexels.com/photos/2294361/pexels-photo-2294361.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="">
                @endif
            </figure>
        ...
        <div class="order-1 lg:order-2">
            <section class="card">
                <div class="card-body">
                   ...
                   <form action="{{route('admin.courses.aproved',$course)}}" class="mt-4" method="POST">
                       @csrf
