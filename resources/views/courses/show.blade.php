    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="text-white">
                ...
                <p class="mb-2"> <i class="fas fa-chart-line"></i> {{$course->level->name}}</p>
            ...
            <section class="card">
                <div class="card-body">
                    ...
                    @can('enrolled', $course)
                        ...
                        <a class="btn btn-danger btn-block mt-4" href="{{route('courses.status', $course)}}">Continuar con el ejercicio</a>
                    ...
                    @else
                        ...
                        @if ($course->price->value == 0)
                            ...
                            <form action="{{route('courses.enrolled',$course)}}" method="POST">
                                @csrf
                                <button class="btn btn-danger btn-block mt-4" type="submit">Llevar este ejercicio</button>
                            </form>
                        @else
                            <p class="text-2xl font-bold text-gray-500 mt-3 mb-2">US$ {{$course->price->value}}</p>
                            <a href="{{route('payment.checkout',$course)}}" class="btn btn-danger btn-block mt-4">Comprar ejercicio</a>
                        @endif
            ...
            <aside class="hidden lg:block">
                @foreach ($similares as $similar)
                    <article class="flex mb-6">
                        ...
                        <div class="ml-3">
                            <h1>
                                <a  class="fon-bold text-gray-500 mb-3" href="{{route('courses.show',$similar)}}">{{Str::limit($similar->title,40)}}</a>
                            </h1>
